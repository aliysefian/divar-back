...
def get_posts(db: Session,city='isfahan'):
    return db.query(models.Posts).filter(models.Posts.city == city).options(defer("description")).order_by(models.Posts.Local_modified.desc()).all()
